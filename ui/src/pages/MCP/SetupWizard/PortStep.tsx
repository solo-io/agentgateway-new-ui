...
const DEFAULT_PORT = 8622;

export function PortStep() {
    const { data, setPort, nextStep } = useMCPWizard();
    ...
    return (
        <div>
            ...
            <StepDescription>
                Set the local port where agentgateway will listen for MCP traffic.
            </StepDescription>
            <Form form={form} layout="vertical" initialValues={{ port: data.port ?? DEFAULT_PORT }}>
                ...
                >
                    <StyledInputNumber placeholder="e.g. 8622" min={1} max={65535} precision={0} />
                </Form.Item>
                <Actions>
